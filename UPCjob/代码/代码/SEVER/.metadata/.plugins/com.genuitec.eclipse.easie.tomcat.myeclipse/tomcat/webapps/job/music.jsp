	...
	<body>
		<table width="80%" border="1" align="center">
			<tr align="center">
				...
				<td >
					<span class="STYLE2">求职意向</span>
				</td>
				<td >
					<span class="STYLE2">生日</span>
				</td>
				<td >
			...
			<%
				ResultSet rs = conn
							.executeQuery("select * from user_tb order by nameID DESC");
					while (rs.next()) {
						String id = rs.getString("nameID");
						String title = rs.getString("name");
						out.println("<tr align=\"center\">");
						out.println("<td><a href=\"../show.jsp?id="+id+"&kind=music\" target=\"_blank\">" + title + "</a></td>");
